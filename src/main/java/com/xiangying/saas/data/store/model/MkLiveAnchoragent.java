...
public class MkLiveAnchoragent {
    private String mkLiveAnchoragentId;
    ...
    public String getMkLiveAnchoragentId() {
        return mkLiveAnchoragentId;
    }

    public void setMkLiveAnchoragentId(String mkLiveAnchoragentId) {
        this.mkLiveAnchoragentId = mkLiveAnchoragentId == null ? null : mkLiveAnchoragentId.trim();
    }
